          ...
          if(point.length != 0){
            ...
            if(time > from1 && time < to1){
              ...
              const dataRaw = {
                ...
                "time": dayjs.utc(logPath.estTimeOfEntry).format("DD-MM-YYYY HH:mm:ss"),
                "callSign": logPath.sfpi.callsign,
                "areg" : logPath.sfpi.aircraftReg,
                "atype" : logPath.sfpi.aircraftType,
                "adep": logPath.sfpi.adep,
                "ades": logPath.sfpi.ades,
                "pointEntry": logPath.sfpi.pointEntry,
                "pointExit": logPath.sfpi.pointExit,
                "route": logPath.sfpi.route,
              }
